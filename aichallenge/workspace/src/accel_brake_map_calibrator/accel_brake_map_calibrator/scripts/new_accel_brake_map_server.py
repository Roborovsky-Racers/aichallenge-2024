...
class DrawGraph(Node):
    ...
    def __init__(self):
        ...
        default_map_path = get_package_share_directory("aichallenge_submit_launch")
        ...
        package_path = get_package_share_directory("aichallenge_submit_launch")
        self.declare_parameter(
        ...
        # debug
        self.get_logger().info("config_file: {}".format(config_file))
